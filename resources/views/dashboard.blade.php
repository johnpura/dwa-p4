...
<html lang="{{ app()->getLocale() }}">
    ...
    <div class="container-fluid">
        <div class="page-wrapper">
            ...
            <h1 class="page-header">Foobooks Dashboard</h1>
            ...
            <div class="table-responsive">
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td>Critical</td>
                        <td>
                            <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#editIncident">
    ...
    <!-- Edit modal -->
    <div class="modal fade" id="editIncident" tabindex="-1" role="dialog" aria-labelledby="editIncidentLabel">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title" id="myModalLabel">Edit Incident</h4>
                </div>
                    ...
                    <form id="" action="" method="">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="indicator">
                                ...
                                <label for="affected-component">Affected Component:</label>
